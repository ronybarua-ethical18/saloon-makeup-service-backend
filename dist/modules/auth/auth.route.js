...
router.put('/verify-email', (0, validateRequest_1.default)(auth_validation_1.AuthValidation.verifyEmailZodSchema), auth_controller_1.AuthController.verifyEmail);
router.put('/reset-password', (0, validateRequest_1.default)(auth_validation_1.AuthValidation.resetPasswordZodSchema), auth_controller_1.AuthController.resetPassword);
