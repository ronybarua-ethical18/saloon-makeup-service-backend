...
router.patch('/:serviceId', (0, auth_1.default)(user_enum_1.ENUM_USER_ROLE.SELLER), booking_controller_1.BookingController.updateBooking);
router.put('/update-many', (0, auth_1.default)(user_enum_1.ENUM_USER_ROLE.SELLER), booking_controller_1.BookingController.updateBookings);
