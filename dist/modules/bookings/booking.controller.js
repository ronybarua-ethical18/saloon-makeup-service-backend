...
const createBooking = (0, tryCatchAsync_1.default)(async (req, res) => {
    ...
    const result = await booking_service_1.SaloonService.createBooking(loggedUser, req.body);
...
const getAllBookings = (0, tryCatchAsync_1.default)(async (req, res) => {
    ...
    const result = await booking_service_1.SaloonService.getAllBookings(loggedUser, queryOptions, filterOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getBooking = (0, tryCatchAsync_1.default)(async (req, res) => {
    if (typeof req.params.bookingId === 'string') {
        const result = await booking_service_1.SaloonService.getBooking(new mongoose_1.default.Types.ObjectId(req.params['bookingId']));
        (0, sendResponse_1.default)(res, {
            statusCode: 200,
            success: true,
...
const updateBooking = (0, tryCatchAsync_1.default)(async (req, res) => {
    const loggedUser = req.user;
    if (typeof req.params.bookingId === 'string') {
        const result = await booking_service_1.SaloonService.updateBooking(loggedUser, new mongoose_1.default.Types.ObjectId(req.params['bookingId']), req.body);
        (0, sendResponse_1.default)(res, {
            statusCode: 200,
            success: true,
...
const deleteBooking = (0, tryCatchAsync_1.default)(async (req, res) => {
    if (typeof req.params.bookingId === 'string') {
        await booking_service_1.SaloonService.deleteBooking(new mongoose_1.default.Types.ObjectId(req.params['bookingId']));
        (0, sendResponse_1.default)(res, {
            statusCode: 200,
            success: true,
