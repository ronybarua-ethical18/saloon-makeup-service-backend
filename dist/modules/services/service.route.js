...
router.post('/update-many', (0, auth_1.default)(user_enum_1.ENUM_USER_ROLE.SUPER_ADMIN), service_controller_1.SaloonServiceController.updateManyServices);
...
router.get('/:serviceId', (0, auth_1.default)(user_enum_1.ENUM_USER_ROLE.SELLER, user_enum_1.ENUM_USER_ROLE.ADMIN, user_enum_1.ENUM_USER_ROLE.SUPER_ADMIN), service_controller_1.SaloonServiceController.getService);
